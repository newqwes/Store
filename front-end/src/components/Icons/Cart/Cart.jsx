...
const Cart = ({ cartItemsCount, size, themeVariant }) => (
  <CartWrapper themeVariant={themeVariant}>
    <svg height={size} width={size} viewBox='0 0 512 512' xmlns='http://www.w3.org/2000/svg'>
      ...
      <path
        d='M406.629 217.171c.21 4.095-1.278 8.1-4.105 11.076a15.005 15.005 0 0 1-10.856 4.654H243.894a15.02 15.02 0 0 1-10.856-4.654 15.017 15.017 0 0 1-4.105-11.076l2.996-59.925c.4-7.97 6.981-14.232 14.961-14.232h141.782c7.98 0 14.562 6.262 14.961 14.232z'
        fill='#4793ff'
      />
      <path
        d='M406.629 217.171c.21 4.095-1.278 8.1-4.105 11.076a15.005 15.005 0 0 1-10.856 4.654h-73.887v-89.887h70.891c7.98 0 14.562 6.262 14.961 14.232z'
        fill='#4756ff'
      />
      <path
        d='m488.047 221.695-26.167 90.536c-7.041 29.423-33.068 49.957-63.34 49.957H179.625c-7.321-29.822-27.755-100.703-42.586-159.25h336.507c4.634 0 9.009 2.147 11.855 5.823a14.979 14.979 0 0 1 2.646 12.934z'
        fill='#dfe7f4'
      />
      <path
        d='m488.047 221.695-26.167 90.536c-7.041 29.423-33.068 49.957-63.34 49.957h-80.758v-159.25h155.764c4.634 0 9.009 2.147 11.855 5.823a14.979 14.979 0 0 1 2.646 12.934z'
        fill='#b6c0d1'
      />
      <circle cx='235.944' cy='467.057' fill='#f0f7ff' r='15' />
      <circle cx='395.493' cy='467.057' fill='#dfe7f4' r='15' />
      <path
        d='M448.581 407.13c0 8.27-6.72 14.98-14.99 14.98H218.92c-27 0-50.2-18.35-56.42-44.63-5.16-18.16-3.24-11.38-61.18-242.91a14.868 14.868 0 0 0-14.42-11.22H38.45c-8.27 0-14.98-6.71-14.98-14.98 0-8.28 6.71-14.98 14.98-14.98H86.9c20.54 0 38.41 13.9 43.46 33.8 0 0 7.19 28.32 16.67 65.76 14.83 58.55 35.26 139.42 42.58 169.24.88 3.56 1.57 6.41 2.04 8.39 3.01 12.7 14.22 21.57 27.27 21.57h214.67c8.27 0 14.991 6.71 14.991 14.98z'
        fill='#47568c'
      />
      <path
